...
class ReIDManager:
    def __init__(self):
        ...
        self.threshold        = getattr(config, 'REID_THRESHOLD', 0.50)
        self.cross_cam_logged = {}
    ...
    def find_or_create(self, embedding, camera_id,
    ...
    def get_snapshot_path(self, global_id):
        with self.lock:
            if global_id in self.unknown_gallery:
                return self.unknown_gallery[global_id].get('snapshot_path')
            return None